  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Book a free consultation call with Zalos to discuss your compliance automation needs." />
      </Head>
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="px-8 py-12 sm:px-12">
              <div className="text-center mb-12">
                ...
                <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                  Ready to transform your compliance processes? Let's discuss how Zalos can help automate your document risk identification and redaction workflows.
                </p>
              </div>
              ...
              {submitted ? (
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-600 mb-8">
                    Thank you for reaching out. We'll get back to you within 24 hours to schedule your free consultation call.
                  </p>
                  <button
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="text-center pt-4">
                    <p className="text-sm text-gray-500">
                      We typically respond within 24 hours. All consultations are free and confidential.
                    </p>
                  </div>
                </form>
              )}
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            <div className="bg-white p-6 rounded-lg shadow-soft">
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-2">Free Consultation</h3>
              <p className="text-gray-600">30-minute call to understand your needs</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-soft">
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-2">Custom Solution</h3>
              <p className="text-gray-600">Tailored approach for your compliance needs</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-soft">
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-2">Fast Implementation</h3>
